...
memory transfers and a GPU kernel can be executed through that stream.
...
However, this is not strictly necessary in this exercise and the functionality of
`MallocAsync` will be discussed more in the GPU memory section.
